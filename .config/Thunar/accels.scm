...
(gtk_accel_path "<Actions>/ThunarWindow/close-tab" "<Alt>q")
...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1720621850636761-1" "<Primary>semicolon")
...
(gtk_accel_path "<Actions>/ThunarStandardView/back-alt1" "<Shift>BackSpace")
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1730572291852956-2" "<Primary><Shift>c")
...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1721171915130704-1" "<Primary>Return")
